 ...
 */class GitApi{constructor(){this.colors={cyan:"\x1B[36m%s\x1B[0m",magenta:"\x1B[35m"},this.makeArch=zipApi.makeArch,this.userArch=zipApi.makeUserArch}/**
   ...
   */async cloneSkeleton(a){fs.mkdir("./tmp"),await download(a,"./tmp",a=>{a&&log(this.colors.magenta,a),log(this.colors.cyan,"Cloned"),this.makeArch("skeleton")})}}module.exports=new GitApi;