"use strict";const commander=require("commander"),cli=require("../helpers/cli"),zipApi=require("../api/zip"),gitApi=require("../api/git"),testCaseGen=require("../api/document"),{pollCase,pollSteps}=require("./document");/**
