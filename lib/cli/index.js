 ...
 */commander.command("v").description("beautifully version showed").action(function(){return cli.version()}),commander.command("info").description("information about options").action(function(){return cli.help()}),commander.command("git:version").description("information about commands for generate git version skeleton").action(function(){return cli.gitVersion()}),commander.command("selenium:last").description("git clone the last version of selenium skeleton").action(function(){return gitApi.cloneSkeleton("AndriyNikiforov/selblui")}),commander.command("appium:last").description("git clone the last version of appium skeleton").action(function(){return gitApi.cloneSkeleton("AndriyNikiforov/appiumwdblui")}),commander.command("webdriverIO:last").description("git clone the last version of webdrtiver.io skeleton").action(function(){return gitApi.cloneSkeleton("AndriyNikiforov/selwdioblui")}),commander.command("selenium <path>").description("generate selenium skeleton").action(function(a){return zipApi.exectArch("../assets/selblui.zip",a)}),commander.command("appium <path>").description("generate appium skeleton").action(function(a){return zipApi.exectArch("../assets/appiumwdblui.zip",a)}),commander.command("webdriver.io <path>").description("generate webdriver.io skeleton").action(function(a){return zipApi.exectArch("../assets/selwdioblui.zip",a)}),module.exports=commander;