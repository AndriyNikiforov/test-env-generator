"use strict";const commander=require("commander"),cli=require("../helpers/cli"),zipApi=require("../api/zip"),gitApi=require("../api/git"),documentGen=require("../api/document"),documentCli=require("./documentCli");/**
